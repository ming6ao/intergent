...
The repo is installable with `npx skills add <owner>/intergent -g`, which means
the root must contain a valid ``SKILL.md`` and the CLI it references must be
bundled. These tests fail if that structure regresses.
"""
